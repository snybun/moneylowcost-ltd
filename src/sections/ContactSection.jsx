      ...
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
            className="lg:col-span-7 bg-[#F5F5F7] border border-[#E5E5E7] rounded-[28px] sm:rounded-[32px] p-7 sm:p-10 shadow-xs"
          >
          ...
          <motion.div
            ...
            className="lg:col-span-5 bg-[#F5F5F7] border border-[#E5E5E7] rounded-[28px] sm:rounded-[32px] p-7 sm:p-10 flex flex-col justify-between space-y-8"
          >
            <div>
